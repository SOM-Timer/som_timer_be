...
class TestExercises(unittest.TestCase):
    ...
    def test_get_all_exercises(self):
        exercise1 = Exercise(url='https://youtube.com', duration='5:00', category='1')
        exercise2 = Exercise(url='https://vimeo.com', duration='15:00', category='2')
        with self.app.app_context():
    ...
    def test_create_exercise(self):
        ...
        self.assertEquals(payload['category'], '3')
